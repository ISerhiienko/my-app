...
var LoginForm = memo(function (_a) {
    ...
    return (_jsx(DynamicModuleLoader, __assign({ removeAfterUnmount: true, reducers: initialReducers }, { children: _jsxs("div", __assign({ className: classNames(cls.LoginForm, {}, [className]) }, { children: [_jsx(Text, { title: t("Форма авторизації") }), _jsx(Input, { autofocus: true, type: "text", className: cls.input, placeholder: t("Логін"), onChange: onChangeUsername, value: username }), _jsx(Input, { type: "text", className: cls.input, placeholder: t("Пароль"), onChange: onChangePassword, value: password }), error && (_jsx(Text, { text: error, theme: TextTheme.ERROR, className: classNames(cls.formError, {}, [className]) })), _jsx(Button, __assign({ className: cls.loginBtn, theme: ButtonTheme.OUTLINE, onClick: onLoginClick, disabled: isLoading }, { children: t("Увійти") }))] })) })));
});
