...
export var ThemeSwitcher = memo(function (_a) {
    ...
    return (_jsx(Button, __assign({ theme: ButtonTheme.CLEAR, className: classNames("", {}, [className]), onClick: toggleTheme }, { children: theme === Theme.DARK ? _jsx(IconDark, {}) : _jsx(IconLight, {}) })));
});
