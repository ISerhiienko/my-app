...
export var AppLink = memo(function (props) {
    var to = props.to, children = props.children, className = props.className, _a = props.theme, theme = _a === void 0 ? AppLinkTheme.PRIMARY : _a, otherProps = __rest(props, ["to", "children", "className", "theme"]);
